...
export default function Footer() {
  const BottomFooter = () => {
    return (
      <React.Fragment>
        <div className="md:flex justify-center gap-5 lg:gap-40 mt-1 font-['Gugi']">
            ...
            <ul>
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex justify-center md:justify-start text-xs md:md:text-sm text-gray-400 pb-2 hover:text-gray-300"
                >
          ...
          <div className="text-white flex text-sm md:text-lg justify-center mb-4 ">
            <ul>
              ...
              <li className=" md:text-xs flex justify-center md:justify-start pb-2 text-gray-400 hover:text-gray-300">
                <a
              ...
              <li className=" md:text-xs flex justify-center md:justify-start pb-2 text-gray-400">
                Hamirpur, Himachal Pradesh, India
              </li>
              <li className=" md:text-xs flex justify-center md:justify-start text-gray-400">
                177005
              </li>
            </ul>
          </div>
        ...
        <div className="text-xs flex justify-center pb-2 text-gray-400">
          © 2022, SPEC NITH
        </div>
      </React.Fragment>
    );
        ...
        <div className="container py-4">
          <div className="max-w-screen-xl md:mt-4 px-8 grid gap-x-24 gap-y-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-24 md:pt-16 pb:10 md:pb-20 mx-auto text-gray-900">
            <div className="flex flex-col justify-around">
              <div>
                <h2 className="text-3xl lg:text-5xl font-bold leading-tight header-theme">
                  Lets talk about everything!
                </h2>
                <div className="text-gray-300 mt-8  text-center flex content-center">
                  Send us an email at{" "}
                  <a
  ...
  return (
    <footer
      id="contact"
      className="flex justify-center px-4 text-gray-800 shadow-lg mb-0 font-['Gugi']  "
    ...
    >
      <div className="container py-1 font-['Gugi'] ">
        <div className="max-w-screen-xl md:mt-4 px-8 grid gap-x-24 gap-y-8 justify-center  md:px-12 lg:px-16 xl:px-24 md:pt-16 md:pb-32 mx-auto text-white-900">
          <div className="flex flex-col justify-around">
            <div>
              <h2 className="text-4xl lg:text-5xl font-['Gugi'] font-bold leading-tight header-theme">
                Lets talk about everything!
              </h2>
          ...
          <div className="max-w-md ">
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-5">
                <button
                  className="uppercase text-sm font-bold tracking-wide bg-blue-600 text-white p-3 rounded-full w-full focus:outline-none focus:shadow-outline hover:bg-blue-700 bg-opacity-40"
                  type="submit"
