const initalQues = [
  {
    ...
    "content": "Well if the Gods of pandemic keep their wrath under control, we are all set for an in-person hackathon."
  },
  {
    "title": "Who can apply?",
  ...
  },
  {
    ...
    "content": "Zero.Zip.Zilch.Nada.Nothing. Registration for this voyage is completely free, thanks to our lunartastic sponsors."
  },
]
...
const moreQues = [
  {
    ...
    "content": "There is no limation in this case. We also welcome a team full of Homo Sapians from various backgrounds or institutions."
  },
    {
      "title": "What do I get from the event?",
      "content": "The winners will be awarded with lunar monetary prizes. The short-listed students will be given recognition and a chance to show off their skills. Winners of the finest hacks created using the pather firms' APIs and SDKs will receive special prizes."
    },
    {
