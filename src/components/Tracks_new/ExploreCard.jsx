...
const ExploreCard = ({ id, imgUrl, title,content, index, active, handleClick }) => (
  ...
  >
    ...
    {active !== id ? (
      ...
      <div className="absolute bottom-0 p-4 md:p-6 3xl:p-10 flex justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
        {/* <div
        ...
        <p className="font-normal text-md md:text-lg 3xl:text-xl leading-[20.16px] text-white">
        {content}
        </p>
