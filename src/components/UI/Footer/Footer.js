...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="flex justify-center px-4 text-gray-800 bg-white dark:text-white dark:bg-gray-800 bg-gray-100 rounded-lg shadow-lg">
      <div className="container py-6">
        <div
          className="max-w-screen-xl md:mt-4 px-8 grid gap-24 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-24 md:pt-16 md:pb-32 mx-auto bg-gray-100 text-gray-900">
          <div className="flex flex-col justify-between ">
            ...
            <img src="email-contact.png" className="hidden md:block " alt="imageContact" />
          </div>
          <div>
