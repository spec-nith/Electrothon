  ...
  return (
    ...
    <nav className="bg-white shadow-lg">
      ...
      <span>
        ...
        {isOpen && (
            <aside className={`transform top-0 left-0 w-64 bg-gray-100 fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30 ${
              ...
              <div className="bg-white rounded-r-3xl overflow-hidden space-y-5">
                <div className="flex w-full items-center justify-center h-20 shadow-md">
                  <h1 className="text-3xl uppercase text-indigo-500">SPEC</h1>
                    ...
                    <a
                      href="#hackers"
                       className="flex flex-row items-center h-12 transform   transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800" onClick={()=>setIsOpen((prevState) => !prevState)}
                    >
                      <span  className="flex items-center justify-center h-12 w-12 text-lg text-gray-400">
                      <FontAwesomeIcon className="text-lg" icon={faHome} fixedWidth />
                      </span>
                    ...
                    >
                      <span  className="flex items-center justify-center h-12 w-12 text-lg text-gray-400">
                      <FontAwesomeIcon className="text-lg" icon={faChalkboardTeacher} fixedWidth />
                      </span>
                    ...
                    >
                      <span  className="flex items-center justify-center h-12 w-12 text-lg text-gray-400">
                      <FontAwesomeIcon className="text-lg" icon={faCalendarDay} fixedWidth />
                      </span>
                    ...
                    >
                      <span  className="flex items-center justify-center h-12 w-12 text-lg text-gray-400">
                      <FontAwesomeIcon className="text-lg" icon={faAward} fixedWidth />
                      </span>
                    ...
                    >
                      <span  className="flex items-center justify-center h-12 w-12 text-lg text-gray-400">
                      <FontAwesomeIcon className="text-lg" icon={faHandHoldingUsd} fixedWidth />
                      </span>
                    ...
                    >
                      <span  className="flex items-center justify-center h-12 w-12 text-lg text-gray-400">
                        <FontAwesomeIcon className="text-lg" icon={faIdCardAlt} fixedWidth />
                      </span>
