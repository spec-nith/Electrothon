...
const Nav = () => {
  ...
  return (
    <React.Fragment>
      ...
      <nav className="fixed z-10 mt-32 ml-2">
        ...
        <div className="md:hidden w-auto items-center pl-3 pr-10 h-16 text-gray-700 z-10 inline-block">
          <div className="md:hidden items-center fixed bg-transparent">
            <button
              ...
              name="Menu Toggler"
            >
              <FontAwesomeIcon className="text-lg text-gray-400 fill-current" icon={faBars} fixedWidth />
            </button>
          </div>
          <Transition
            show={isOpen}
