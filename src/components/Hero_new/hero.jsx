...
export default function Hero(props) {
  return (
    <div
      ...
      style={props.style}
    >
      <div className="[background:url(https://uortjlczjmucmpaqqhqm.supabase.co/storage/v1/object/public/firejet-converted-images/images/ded6f1915aa2f26728cd9b331c8f83a20257ef18.webp)_center_/_cover] inset-x-0 bottom-0 absolute w-[1440px] top-[53.41%]" />
      <div
        className={`inset-x-0 absolute top-0 w-[1440px] bottom-[46.59%] bg-[rgba(13,11,12,1)] overflow-clip h-[1121px] font-['Gugi']`}
      >
        <div>
          <div className="[background:url(https://uortjlczjmucmpaqqhqm.supabase.co/storage/v1/object/public/firejet-converted-images/images/ded6f1915aa2f26728cd9b331c8f83a20257ef18.webp)_center_/_cover] left-px top-0 absolute w-[1440px] h-[978px]" />
        </div>
        <div>
          <div className="[background:url(https://uortjlczjmucmpaqqhqm.supabase.co/storage/v1/object/public/firejet-converted-images/images/ded6f1915aa2f26728cd9b331c8f83a20257ef18.webp)_center_/_cover] left-px absolute w-[1440px] h-[978px] top-[139px]" />
        </div>
        ...
        <div className="text-left text-[rgba(114,114,114,1)]">
          <div className="[box-shadow:0px_0px_0px_1px_rgba(114,_114,_114,_1)_inset] [box-shadow-width:1px] absolute gap-2.5 flex justify-center items-center p-2.5 w-[191.62px] h-[57px] left-[736.36px] top-[710px] rounded-[1000px]">
            <button className="text-xl m-0 leading-[normal]">Learn more</button>
          </div>
        </div>
