...
export default function faq() {
  const FaqArray = [
    ...
    },
    {
      ...
      content:
        " We want to create an environment that embraces new ideas and technology solutions at the industry level. A place where technology designers and developers can come to help real life problems which can be solved through engineering. We know it takes longer than a weekend tobuild great solutions, but this is ample time to form teams of good people and begin creatinggreat solutions.",
    },
    {
    ...
    return (
      <div className="border-b faqs-tab">
        <div className="border-l-2 border-transparent relative">
          ...
          />
          <header
            className="flex justify-between items-center pt-5 pb-3 px-8 cursor-pointer select-none faqs-tab-label"
            htmlFor="chck1"
          >
